...
{
	/// <summary>
	/// Description of InvokeUIATableSelectItemByNameCommand.
	/// </summary>
	[Cmdlet(VerbsLifecycle.Invoke, "UIATableSelectItemByName")]
	public class InvokeUIATableSelectItemByNameCommand : HasControlInputCmdletBase
	{
		public InvokeUIATableSelectItemByNameCommand()
		{
		}
